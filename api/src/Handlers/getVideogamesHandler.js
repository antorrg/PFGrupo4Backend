...
const getVideogamesHandler = async (req, res) => {
    const {page = 0, size = 5, platforms, genres, minPrice, maxPrice, onlyPrice, name} = req.query;
    ...
    try {
        const videogamesData = await getVideogames(page, size, filters, platformsFilters, genresFilters);
